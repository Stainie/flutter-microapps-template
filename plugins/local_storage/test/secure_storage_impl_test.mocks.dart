...
// in local_storage/test/secure_storage_impl_test.dart.
...
class MockCrashlyticsService extends _i1.Mock
  ...
  @override
  _i3.Future<void> logNetworkError({
    required String? url,
  ...
  @override
  _i3.Future<void> setCurrentScreen(String? currentPage) => (super.noSuchMethod(
        Invocation.method(
          #setCurrentScreen,
          [currentPage],
        ),
  ...
  @override
  _i3.Future<void> onFlutterError(_i5.FlutterErrorDetails? details) =>
      (super.noSuchMethod(
        Invocation.method(
          #onFlutterError,
          [details],
