...
import 'package:result/result_checker.dart';
...
class EmptyOk<ERR extends Object> extends Ok<ERR, Empty> {
  const EmptyOk() : super(const Empty());
}

extension ResultIterableExtension<ERR extends Object, OK extends Object>
    on Iterable<Result<ERR, OK>> {
  Iterable<OK> get thatAreOk => whereType<Ok<ERR, OK>>().map((o) => o.val);
  Iterable<ERR> get thatAreErr => whereType<Err<ERR, OK>>().map((e) => e.val);
}
